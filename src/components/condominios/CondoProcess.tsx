    ...
    <section className="py-24 bg-zinc-50 border-t border-zinc-200">
      <div className="container mx-auto px-6">
        <motion.h2
          ...
          viewport={{ once: true }}
          className="text-3xl lg:text-5xl font-heading font-bold text-center text-zinc-900 mb-20"
        >
          Como funciona
        </motion.h2>
          ...
          {steps.map((step, i) => (
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-2xl font-heading font-bold text-zinc-900 mb-4">{step.title}</h3>
